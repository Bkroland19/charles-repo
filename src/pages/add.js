					...
					<div id="content-wrapper">
						...
						<div className="container-fluid">
							<div className="card mx-auto">
								<div className="card-header">Person Add</div>
												...
												<div className="col-md-6">
													<div className="form-label-group">
														<input
															...
															autoFocus="autofocus"
														/>
														<label htmlFor="inputName">Enter Full Names</label>
													</div>
												</div>
												<div className="col-md-6">
													<div className="form-label-group">
														<input
															...
															required="required"
														/>
														<label htmlFor="inputPhone">Enter PhoneNo</label>
													</div>
												</div>
											</div>
										</div>
												...
												<div className="col-md-6">
													<div className="form-label-group">
														<input
															...
															required="required"
														/>
														<label htmlFor="inputComp">Enter College</label>
													</div>
												</div>
											</div>
										</div>
						...
						<footer className="sticky-footer">
							<div className="container my-auto">
								<div className="copyright text-center my-auto">
									<span>
										Copyright © Stratcom <div>{new Date().getFullYear()}</div>
									</span>
								</div>
							</div>
						</footer>
